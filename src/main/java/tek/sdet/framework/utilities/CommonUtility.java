...
public class CommonUtility extends BaseSetup {
	...
	//screenshot will be stored in bytes
	...
	public void selectByVisibleText(WebElement ele, String visisbleText) {
		Select select = new Select(ele);
	...
	public void deselectByVisisbleText(WebElement ele, String visibleText) {
		Select select = new Select (ele);
